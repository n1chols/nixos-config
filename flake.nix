        ...
        ({ pkgs, ... }: {
          ...
          services.greetd = {
            ...
            settings.default_session = {
              user = "user";
              command = "gamescope -W 3840 -H 2160 --framerate-limit 120 --adaptive-sync --hdr-enabled --hdr-itm-enable -- sh -c '${steam}/bin/steam -silent -nofriendsui & pegasus-fe'";# > /dev/null 2>&1";
            };
          };
        })
      ];
