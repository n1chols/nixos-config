  ...
  modules = {
    ...
    sessions = {
      ...
      commands = [
        ...
        "env CLUTTER_BACKEND=wayland GDK_BACKEND=wayland QT_WAYLAND_DISABLE_WINDOWDECORATION=1 DESKTOP_SESSION=plasma XDG_CURRENT_DESKTOP=KDE XDG_SESSION_TYPE=wayland QT_QPA_PLATFORM=wayland startplasma-wayland"
      ];
    };
  };
